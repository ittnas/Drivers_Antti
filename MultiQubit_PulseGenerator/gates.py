...
class SpinlockingGate(BaseGate, OneQubitGate):
    """Single qubit rotations around the XY axes.
...
class SingleQubitXYRotation_12(BaseGate, OneQubitGate):
    """Single qubit rotations around the XY axes.
...
#spin locking gates
SL_X = SpinlockingGate(phi=0, theta=np.pi)
SL_Y = SpinlockingGate(phi=np.pi/2, theta=np.pi)
...
Xp_12 = SingleQubitXYRotation_12(phi=0, theta=np.pi)
Xm_12 = SingleQubitXYRotation_12(phi=0, theta=-np.pi)
X2p_12 = SingleQubitXYRotation_12(phi=0, theta=np.pi/2)
X2m_12 = SingleQubitXYRotation_12(phi=0, theta=-np.pi/2)

Yp_12 = SingleQubitXYRotation_12(phi=np.pi/2, theta=np.pi)
Ym_12 = SingleQubitXYRotation_12(phi=np.pi/2, theta=-np.pi)
Y2p_12 = SingleQubitXYRotation_12(phi=np.pi/2, theta=np.pi/2)
Y2m_12 = SingleQubitXYRotation_12(phi=np.pi/2, theta=-np.pi/2)
# Z gates
